...
Програмний модуль **`sentiment-analyser-en`** здійснює завантаження навченої моделі сентимент-аналізу інформаційних повідомлень поданих англійською мовою, далі очікує та зчитує вхідний потік у форматі `JSON`, звідки відбирає поле `text` з текстом інформаційного повідомлення. В результаті опрацювання функцією `predict()` бібліотеки [fastText](https://github.com/facebookresearch/fastText) здійснює сентимент-аналіз вхідного текстового повідомлення й вивід у вихідний потік вихідного `JSON`.
