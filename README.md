...
Далі було здійснено процес навчання засобами [fastText](https://github.com/facebookresearch/fastText) (функція `fastText.train_supervised()`). Для навчання моделей були налаштовані наступні гіперпараметри: 
``` python
hyper_params = { 
